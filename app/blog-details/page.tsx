              ...
              <div className="col-12 col-lg-8">
                <div className="blog-post-details mb-xxl-10 mb-xl-8 mb-lg-7 mb-6">
                  <div className="single-blog-post">
                    ...
                    >
                      <img
                        src="/assets/img/blog/blog-details-b1.png"
                        alt="img"
                        className="w-100"
                      />
                    </div>
                    <div className="post-content">
                      ...
                      >
                        <span>Written by: Marry biden</span>
                      ...
                      <div className="mb-xxl-13 mb-xl-10 mb-lg-8 mb-7">
                        ...
                        >
                          ...
                          consequat nisi, quis luctus nisl. Praesent faucibus
                          sem id massa semper ornare. Nam eu magna at mi
                          pellentesque mattis. Morbi at condimentum velit.
                          Phasellus aliquet, leo auctor volutpat ultrices, metus
                          dolor dictum enim, sed convallis lacus urna nec erat.
                        </p>
                        <p
                          className="pra-clr"
                          data-aos="fade-left"
                        ...
                        >
                          consectetur adipiscing elit. Etiam at mauris accumsan
                          mi pulvinar lacinia a in justo. Ut tempor et libero
                          quis dignissim. Nulla at convallis libero, vitae
                          aliquam leo. Etiam ut augue nibh. In laoreet neque
                          quis ex ornare, quis auctor elit facilisis. Mauris
                          dapibus massa rhoncus ligula luctus vulputate. Fusce
                          condimentum placerat vulputate. Praesent ullamcorper
                          dui in dui sagittis commodo.
                        </p>
                      </div>
                      <h5
                      ...
                      <div className="row g-xl-4 g-3 mb-xxl-10 mb-xl-7 mb-lg-6 mb-4">
                        ...
                        >
                          <div className="details-thumb-b1 w-100">
                            <img
                              src="/assets/img/blog/blog-details-s2.png"
                              alt="img"
                              className="w-100"
                            />
                          </div>
                        ...
                        >
                          <div className="details-thumb-b1 w-100">
                            <img
                              src="/assets/img/blog/blog-details-s1.png"
                              alt="img"
                              className="w-100"
                            />
                          </div>
                ...
                <div className="nextprevius-text d-flex align-items-center justify-content-between mb-xxl-6 mb-xl-5 mb-4">
                  ...
                  >
                    ...
                    <span className="dd-clr">Previous blog</span>
                  </Link>
                  <Link
                    href="/blog-details"
                    className="dd-clr"
                ...
                <div className="row g-xl-7 g-4 mb-xxl-15 mb-xl-10 mb-8">
                  ...
                  >
                    <div className="recent-items bg1-clr d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2 py-xxl-6 py-xl-4 py-3 px-xxl-7 px-xl-5 px-lg-4 px-3">
                      <div className="recent-thumb">
                        <img
                          src="/assets/img/blog/details-small3.png"
                          alt="img"
                        />
                      </div>
                  ...
                  >
                    <div className="recent-items bg1-clr d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2 py-xxl-6 py-xl-4 py-3 px-xxl-7 px-xl-5 px-lg-4 px-3">
                      <div className="recent-thumb">
                        <img
                          src="/assets/img/blog/details-small4.png"
                          alt="img"
                        />
                      </div>
                      <div className="recent-content">
