  ...
  return (
    <>
      <Layout
        headerStyle={2}
        footerStyle={3}
        breadcrumbTitle="Our Team Details"
      >
        <section className="team-details pt-space pb-space">
          <div className="container">
            <div
              className="team-details-box cmn-border d-lg-flex d-grid justify-content-lg-start justify-content-center align-items-center gap-xxl-7 gap-xl-4 gap-lg-3 p-xxl-7 p-xl-5 p-lg-4 p-3 mb-xxl-15 mb-xl-10 mb-8"
              data-aos="zoom-in"
              data-aos-duration={2000}
            >
              <div
                className="thumb text-lg-start text-center mb-4 w-lg-auto w-100"
              ...
              <div className="content text-lg-start text-center">
                ...
                <span className="pra-clr">Programmer</span>
                <p className="pra-clr mt-xxl-4 mt-xl-3 mt-2">
                  Phasellus leo tortor, porttitor id volutpat sagittis, dapibus
                  a libero. Vivamus ac pretium justo. Vestibulum lobortis tortor
                  nec eros viverra placerat. Sed ut sagittis nibh. Ut non
                  ultricies velit. Phasellus vestibulum quam eu varius cursus.
                  In ante sem, congue quis libero at, tempor aliquet mauris.
                </p>
                <ul className="leslie-info d-flex justify-content-lg-start justify-content-center flex-wrap align-items-center gap-xxl-7 gap-xl-6 gap-lg-5 gap-md-4 gap-3 bb-border bt-border py-xxl-5 py-xl-4 py-lg-3 py-2 my-xxl-8 my-xl-7 my-lg-6 my-5">
                  <li className="pra-clr">Experience: 10 Years</li>
                  <li className="pra-clr">Phone: +1 880-555-3535</li>
                  <li className="pra-clr">Email: info@exmple.com</li>
                </ul>
            ...
            <div className="case-study-detials-inner">
              <h4 className="mb-xxl-7 mb-4 white-clr">Professional Info</h4>
              <div className="d-flex flex-lg-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 bb-border pb-xxl-13 pb-xl-10 pb-8 ">
                <p
                  className="pra-clr challenge-pra1"
                  data-aos="zoom-in-left"
                ...
                >
                  ...
                  <span className="pra-clr mt-xxl-7 mt-xl-4 mt-3 d-block">
                    ...
                    eu pulvinar lorem. Etiam vestibulum ligula quis nisl
                    feugiat.
                  </span>
                </p>
                <div className="result-progress-wrap w-100">
                  <div className="progres-item mb-xxl-6 mb-xl-5 mb-4">
                    <div className="d-flex align-items-center justify-content-between mb-xxl-5 mb-3">
                      <span className="conssub">Branding Design</span>
                  ...
                  <div className="progres-item mb-xxl-6 mb-xl-5 mb-4">
                    <div className="d-flex align-items-center justify-content-between mb-xxl-5 mb-3">
                      <span className="conssub">Business</span>
                  ...
                  <div className="progres-item">
                    <div className="d-flex align-items-center justify-content-between mb-xxl-5 mb-3">
                      <span className="conssub">Web Design</span>
            ...
            <div className="d-flex align-items-center justify-content-between gap-3">
              <h3 className="related-title white-clr">Related Member</h3>
