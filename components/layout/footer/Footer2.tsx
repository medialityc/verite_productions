              ...
              <div className="col-xxl-6 col-xl-6 col-lg-7">
                <div className="footer-widget">
                  <div className="footer-lets-title mb-xxl-20 mb-xl-15 mb-lg-10 mb-8">
                    <span
                      className="fdisplay-title d-flex gap-2 align-items-center mb-xxl-10 mb-xl-8 mb-lg-6 mb-6"
                  ...
                  <div className="d-flex footer-widger-inner align-items-center">
                      ...
                      >
                        ...
                        >
                          <line
                            ...
                            stroke="url(#paint0_linear_6308_43042)"
                            strokeWidth={2}
                          />
                          <defs>
                            <linearGradient
                              id="paint0_linear_6308_43042"
                              x1="4.02912"
                              y1="0.000277584"
                              x2={80}
                              y2="0.000110496"
                    ...
                    <div className="box2">
                      ...
                      >
                        ...
                        >
                          <line
                            ...
                            y2={-1}
                            transform="matrix(1 0 0 -1 0 0)"
                            stroke="url(#paint0_linear_6308_43)"
                            strokeWidth={2}
                          />
                          <defs>
                            <linearGradient
                              id="paint0_linear_6308_43"
                              x1="4.02912"
                              y1="0.000277584"
                              x2={80}
                              y2="0.000110496"
                      ...
                      <p
                        className="pra-clr mb-xxl-7 mb-xl-6 mb-6"
                        data-aos="zoom-in"
                        data-aos-duration={1400}
                      >
                  ...
                  <div className="row g-xxl-8 g-xl-7 g-6">
                    ...
                    >
                      <div className="gorm-grp">
                        <label
                          className="fw-medium white mb-xxl-5 mb-xl-4 mb-3"
                          htmlFor="name"
                        >
                          Your Name*
                        </label>
