            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="project-count-item d-center">
                <div className="box">
                  ...
                  <span className="pra-clr">Team member</span>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="project-count-item d-center">
                <div className="box">
                  ...
                  <span className="pra-clr">Project Done</span>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="project-count-item d-center">
                <div className="box">
                  ...
                  <span className="pra-clr">Happy Clients</span>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="project-count-item d-center">
                <div className="box">
                  ...
                  <span className="pra-clr">Winning Award</span>
                </div>
              </div>
            </div>
          </div>
