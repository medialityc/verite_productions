        ...
        <div className="container">
          ...
          <div className="text-md-start text-center d-md-flex d-grid align-items-center justify-content-md-between justify-content-center mt-xxl-20 mt-xl-15 mt-lg-10 mt-md-0 mt-0">
            <div className="about-sponsor">
              <div
                className="brand d-flex gap-4 align-items-center mb-xxl-8 mb-xl-7 mb-lg-5 mb-4"
                data-aos="zoom-in-up"
                data-aos-duration={1600}
                data-aos-delay={5}
              >
                <h6>1k + Brands Trust Us</h6>
                <span className="brand-border d-xl-block d-none"></span>
              </div>
              <div
            ...
            >
              ...
              <Link
                href="/about"
                className="explore-more d-inline-flex align-items-center gap-2"
              >
                Explore More
