        ...
        <div className="container position-relative">
          <div className="row g-6">
            <div className="col-lg-5">
              <div
                className="testimonial-thumbv02 w-100 position-relative"
                data-aos="zoom-in"
                data-aos-duration={1400}
                data-aos-delay={50}
              >
                <img
                  src="/assets/img/testimonial/testimonialv2.png"
                  alt="img"
                  className="w-100"
                />
                    ...
                    <div className="testimonial-zero-oneitem">
                      <div className="content ms-xl-15">
                        ...
                        <p className="pra-clr mb-xxl-8 mb-xl-6 mb-lg-5 mb-4">
                          Purus, ultricies ut orci eget, accumsan dignissim
                          tortor. Quisque sagittis, massa ac luctus facilisis,
                          dui diam egestas sem, a congue quam neque id lectus.
                          Phasellus vel imperdiet erat. Proin mollis, ligula
                          mollis tempus condimentum, urna mauris pretium tellus,
                          eu.
                        </p>
                        <div className="vector d-md-block d-none mb-xxl-5 mb-4 w-100">
                          <img
                            src="/assets/img/element/testi-v2-element.png"
                            alt="img"
                            className="w-100"
                          />
                        </div>
                        <div className="d-flex align-items-center gap-xxl-3 gap-2">
                          <div className="savannah">
                            <img
                              src="/assets/img/testimonial/nguyen.png"
                              alt="img"
                            />
                          </div>
                          <div className="desig">
