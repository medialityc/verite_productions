                  ...
                  <div className="content">
                    <div className="d-flex align-items-center gap-xxl-5 gap-3">
                      <div className="savannah">
                        <img
                          src="/assets/img/testimonial/testiv3-1.png"
                          alt="img"
                        />
                      </div>
                      <div className="desig">
                        <h6 className="white-clr mb-1">Kathryn Murphy</h6>
                    ...
                    <p className="pra-clr mt-xxl-8 mt-xl-6 mt-lg-5 mt-4">
                      Consectetur adipiscing elit. Integer is nunc viverra
                ...
                <div className="testimonial-zero-oneitem testimonial-zero-oneitemv3 d-flex align-items-center gap-xxl-6 gap-xl-4 gap-3">
                  ...
                  <div className="content">
                    <div className="d-flex align-items-center gap-xxl-5 gap-3">
                      <div className="savannah">
                        <img
                          src="/assets/img/testimonial/testiv3-3.png"
                          alt="img"
                        />
                      </div>
                      <div className="desig">
                        <h6 className="white-clr mb-1">Leslie Alexander</h6>
                        <span className="pra-clr mb-2 d-block">
                          Web Designer
                        </span>
                        <div className="ratting-area d-flex align-items-center gap-2">
                ...
                <div className="testimonial-zero-oneitem testimonial-zero-oneitemv3 d-flex align-items-center gap-xxl-6 gap-xl-4 gap-3">
                  ...
                  <div className="content">
                    <div className="d-flex align-items-center gap-xxl-5 gap-3">
                      <div className="savannah">
                        <img
                          src="/assets/img/testimonial/testiv3-2.png"
                          alt="img"
                        />
                      </div>
                      <div className="desig">
                        <h6 className="white-clr mb-1">Savannah Nguyen</h6>
                        <span className="pra-clr mb-2 d-block">
                          Nursing Assistant
                        </span>
                        <div className="ratting-area d-flex align-items-center gap-2">
