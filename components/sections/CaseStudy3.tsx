    ...
    <>
      <section className="case-study-sectionv3 position-relative mt-50">
        ...
        <div className="case-study-v3wrap">
          <div
            className="case-studyv3-item position-relative"
            style={{
              background:
                "url(assets/img/case/ncase1.png) no-repeat center center",
          ...
          <div
            ...
            style={{
              background:
                "url(assets/img/case/ncase2.png) no-repeat center center",
              backgroundSize: "cover",
            }}
            data-aos="fade-up"
          ...
          <div
            ...
            style={{
              background:
                "url(assets/img/case/ncase3.png) no-repeat center center",
              backgroundSize: "cover",
            }}
            data-aos="fade-up"
