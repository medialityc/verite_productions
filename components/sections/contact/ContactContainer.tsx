...
function ContactContainer() {
  ...
  const sendEmail = (e: any) => {
    ...
    const mailtoLink = `mailto:rbarria@veriteproducciones.net?subject=${subject}&body=${body}`;
    window.location.href = mailtoLink; // Redirige al enlace mailto
  };
  return (
      ...
      <div className="container">
        <div className="row g-xl-7 g-4 mb-xxl-7 mb-6 justify-content-center">
          ...
          >
            <div className="contact-sub-info bg1-clr text-center">
              ...
              <span className="msub d-block mb-2">
                (507) 221-9303 | (507) 224-0566 <br />
                (507) 6612-7525 (Ricardo Barría)
                <br /> (507) 6612-6739 (Rigoberto Gúzman)
              </span>
            </div>
          </div>
          <div
          ...
          >
            <div className="contact-sub-info bg1-clr text-center">
              ...
              <span className="msub d-block mb-2">
                ...
                <br /> rickybarria@gmail.com
                <br />
                rguzman@veriteproducciones.net
                <br />
                arivera@veriteproducciones.net
              </span>
            </div>
          </div>
          <div
          ...
          >
            <div className="contact-sub-info bg1-clr text-center">
              <img
                src="\assets\img\logo\social-media (2).png"
                alt="social"
                width={64}
                height={64}
              />
              ...
              >
                ...
                <br />
                X:{" "}
                <a target="_blank" href="https://x.com/veritepanama">
                  @veritepanama
                </a>
                <br />
                Facebook:
        ...
        <div className="row g-xxl-7 g-4">
          <div className="col-lg-6" data-aos="zoom-in" data-aos-duration={2000}>
            <div className="contact-map">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3940.499092844002!2d-79.4863139!3d9.0181528!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8faca9eb5f4dec0f%3A0x4618abe8beafe0ea!2sVerite%20Producciones%2C%20S.%20A.!5e0!3m2!1ses-419!2sus!4v1730400209130!5m2!1ses-419!2sus"
                allowFullScreen
                loading="lazy"
