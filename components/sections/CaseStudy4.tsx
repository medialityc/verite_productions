          ...
          <div className="onhover-tabbing-wrap position-relative">
            <div className="row justify-content-between align-items-center g-xxl-10 g-xl-8 g-5">
              ...
              <div className="col-lg-7">
                ...
                >
                  <div
                    className={`nav-link px-0 pb-xxl-10 pb-xl-8 pb-lg-6 pb-4 ${
                      isTab === 1 ? "active" : ""
                    }`}
                  ...
                  >
                    <div className="info-left">
                      ...
                      <h4 className="white-clr text-start">Brooklyn Simmons</h4>
                    </div>
                  ...
                  <div
                    className={`nav-link px-0 py-xxl-10 py-xl-8 py-lg-6 py-4 ${
                      isTab === 2 ? "active" : ""
                    }`}
                  ...
                  >
                    <div className="info-left">
                      ...
                      <h4 className="white-clr text-start">Ronald Richards</h4>
                    </div>
                    <div className="social-profile">
                      <ul>
                        <li>
                  ...
                  >
                    <div className="info-left">
                      ...
                      <h4 className="white-clr text-start">Marvin McKinney</h4>
                    </div>
                    <div className="social-profile">
                      <ul>
                        <li>
