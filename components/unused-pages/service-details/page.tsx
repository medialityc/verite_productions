        ...
        <section className="Service-details pt-space pb-space">
          <div className="container">
            <div className="service-details-header bb-border pb-xxl-9 pb-xl-7 pb-6">
              <div
                className="thumb w-100 mb-xxl-12 mb-xl-9 mb-sm-6 mb-5"
                data-aos="zoom-in"
              ...
              >
                <Link
                  ...
                  className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3 theme-clr"
                >
                  Creative
                </Link>
                <Link
              ...
              <Swiper {...swiperOptions} className="swiper-wrapper">
                <SwiperSlide>
                  <div className="study-thumb-slide w-100">
                    <img
                      src="/assets/img/service/service-slide1.png"
                      alt="img"
                      className="w-100"
                    />
                  </div>
                ...
                <SwiperSlide>
                  <div className="study-thumb-slide w-100">
                    <img
                      src="/assets/img/service/service-slide2.png"
                      alt="img"
                      className="w-100"
                    />
                  </div>
