              ...
              <div className="col-12 col-lg-8">
                <div className="blog-post-details">
                  <div className="single-blog-post cmn-border p-xxl-7 p-xl-6 p-lg-4 p-3 mb-xxl-7 mb-xl-7 mb-lg-6 mb-5">
                    <div
                      className="post-featured-thumb w-100 mb-xxl-7 mb-xl-6 mb-5"
                      data-aos="zoom-in"
                      data-aos-duration={1400}
                    >
                      <img
                        src="/assets/img/blog/blog-details-b2.png"
                        alt="img"
                        className="w-100"
                      />
                    </div>
                    <div className="post-content">
                      <div
                        className="post-marry d-flex align-items-center gap-xxl-8 gap-xl-6 gap-4 gap-3 mb-xxl-6 mb-xl-5 mb-sm-4 mb-3"
                        data-aos="fade-left"
                        data-aos-duration={1500}
                      >
                        <span>
                          Written by:{" "}
                          <span className="tag-clr"> Marry biden</span>
                        </span>
                        <i className="fas fa-circle white" />
                        <span className="tag-clr">10/01/2024</span>
                      </div>
                      <h5
                        className="white mb-xxl-8 mb-xl-7 mb-sm-6 mb-5"
                        data-aos="fade-left"
                      ...
                      <p
                        className="pra-clr mb-xxl-10 mb-xl-8 mb-sm-7 mb-6"
                        data-aos="fade-left"
                      ...
                      <div className="d-flex align-items-center justify-content-between">
                        <Link
                          href="/blog-details"
                          className="blog-singelbtn d-center whitebg"
                          data-aos="zoom-in"
                          data-aos-duration={1400}
                        >
                        ...
                        <Link
                          href="/blog-details"
                          className="shapre-btn d-flex align-items-center gap-2 cmn-border py-xxl-3 py-2 px-xxl-6 px-4 pra-clr"
                  ...
                  <div className="single-blog-post cmn-border p-xxl-7 p-xl-6 p-lg-4 p-3 mb-xxl-7 mb-xl-7 mb-lg-6 mb-5">
                    ...
                    >
                      <img
                        src="/assets/img/blog/blog-details-b3.png"
                        alt="img"
                        className="w-100"
                      />
                    </div>
