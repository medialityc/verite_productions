            ...
            <div className="row g-xxl-7 g-xl-6 g-6">
              ...
              >
                <div className="blog-widget-item bb-border pb-xxl-7 pb-xl-6 pb-4">
                  <div className="thumb w-100 overflow-hidden mb-xxl-7 mb-xl-6 mb-4">
                    <img
                      src="/assets/img/case/study-grid1.png"
                      alt="img"
              ...
              >
                <div className="blog-widget-item bb-border pb-xxl-7 pb-xl-6 pb-4">
                  <div className="thumb w-100 overflow-hidden mb-xxl-7 mb-xl-6 mb-4">
                    <img
                      src="/assets/img/case/study-grid2.png"
                      alt="img"
                      className="w-100 overflow-hidden"
                    />
                  </div>
              ...
              >
                <div className="blog-widget-item bb-border pb-xxl-7 pb-xl-6 pb-4">
                  <div className="thumb w-100 overflow-hidden mb-xxl-7 mb-xl-6 mb-4">
                    <img
                      src="/assets/img/case/study-grid3.png"
                      alt="img"
                      className="w-100 overflow-hidden"
                    />
                  </div>
              ...
              >
                <div className="blog-widget-item bb-border pb-xxl-7 pb-xl-6 pb-4">
                  <div className="thumb w-100 overflow-hidden mb-xxl-7 mb-xl-6 mb-4">
                    <img
                      src="/assets/img/case/study-grid4.png"
                      alt="img"
                      className="w-100 overflow-hidden"
                    />
                  </div>
              ...
              >
                <div className="blog-widget-item bb-border pb-xxl-7 pb-xl-6 pb-4">
                  <div className="thumb w-100 overflow-hidden mb-xxl-7 mb-xl-6 mb-4">
                    <img
                      src="/assets/img/case/study-grid5.png"
                      alt="img"
                      className="w-100 overflow-hidden"
                    />
                  </div>
              ...
              >
                <div className="blog-widget-item bb-border pb-xxl-7 pb-xl-6 pb-4">
                  <div className="thumb w-100 overflow-hidden mb-xxl-7 mb-xl-6 mb-4">
                    <img
                      src="/assets/img/case/study-grid6.png"
                      alt="img"
                      className="w-100 overflow-hidden"
                    />
                  </div>
